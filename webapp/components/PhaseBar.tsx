import { SCRAPE_PHASES, type PhaseProgress } from "@/lib/scrape/logFormat";

/**
 * Where a run has got to, as four segments.
 *
 ...
 * skill's step numbering. The phase comes from lib/scrape/logFormat.ts, derived
 * from those same lines — no new state, nothing the run has to cooperate with.
 *
